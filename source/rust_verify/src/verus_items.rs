...
fn verus_items_map() -> Vec<(&'static str, VerusItem)> {
    vec![
        ...
        ("verus::verus_builtin::assert_lean_by",          VerusItem::Assert(AssertItem::AssertLean)),
        ("verus::verus_builtin::assert_lean_proof",        VerusItem::Assert(AssertItem::AssertLeanProof)),
